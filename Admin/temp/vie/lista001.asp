...
sSql = "select familia,count (familia) as pepe, ds_familia from reserva where estado = '1' and  not familia = 'ADMIN' AND not familia = 'UNIFE' AND not familia = 'RESERVADO' group by familia, ds_familia order by ds_familia "
Rs.Open sSql, Cn
%>
	...
	<TABLE border='1' cellpadding = '2' cellspacing = '1'>
		...
		%>
			<TR>
				...
				<td style=" font-family: sans-serif;" width="350"><%= Rs1("ds_familia") %></td>
				<td style=" font-family: sans-serif; text-align:center;" width="20"><%= Rs("pepe") %></td>
				<% do while not rs1.eof 
				If isNull(Rs1("final")) then %>
					<td style=" font-family: sans-serif; text-align:center;" width="50" ><a href="deleteasiento.asp?asiento=<%= Rs1("asiento") %>"><%= Rs1("asiento") %></td>
				<% Else	%>
					<td style=" font-family: sans-serif; text-align:center;" width="50" ><a href="deleteasiento.asp?asiento=<%= Rs1("asiento") %>"><%= Rs1("asiento") %></td>
				<%  End If
				rs1.movenext
