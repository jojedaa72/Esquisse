...
Sql = "select count (familia) - 56 as direccion, count (familia)-56  as total, 800 - count (familia) as reservadas, (count (familia)*100)/800 as tota1  from reserva where estado = '1' "
Rs.Open Sql, Cn

sSql = "select count (familia) - 56 as direccion, count (familia)-56 as total, 800 - count (familia) as reservadas, (count (familia)*100)/800 as tota1 from reserva1 where estado = '1' "
Rs1.Open sSql, Cn
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel-heading"><h3><strong>Estadística en línea - Esquisse 2019 </strong></h3></div>
			<p class="text-center" style="padding-top: 12px; padding-bottom: 0px"><a href="estadistica.asp" class="glyphicon glyphicon-refresh"> Actualizar</a></p>
...
<div class="container">
	<div class="row">
		<div class="col_md_12">
		<h4 class="text-center">Venta x día</h4>
		<table class="table table-striped">
			<tr>
				...
				<td>
					<table class="table text-center">
						<tr class="active">
							<th class=text-center>Viernes 20</th>
						</tr>
				...
				<td>	
					<table class="table text-center">
						<tr class="active">
							<th class=text-center>Sábado 21</th>
						</tr>
