...
sSql = "select familia,count (familia) as pepe, ds_familia from reserva where estado = '1' and not familia = 'DIRECCION' and not familia = 'ADMIN' and not familia = 'sistemas' group by familia, ds_familia order by ds_familia "
Rs.Open sSql, Cn
%>
